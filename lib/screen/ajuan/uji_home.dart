...
class UjiHome extends StatefulWidget {
  const UjiHome({super.key});

  @override
  State<UjiHome> createState() => _UjiHomeState();
}

class _UjiHomeState extends State<UjiHome> {
  String? token;
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Padding(
            ...
            child: const Text("List Pengujian"),
          ),
                    ...
                    MaterialButton(
                      onPressed: () {
                        popUpWidget.showAlertWidget(
                          ...
                          'Next', 
                          "Back",
                          FormUjiInternal(id: getDataList[index].id ?? 0, nomor: getDataList[index].nomorPengajuan ?? "",), UjiHome());
                      },
                      child: Container(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 12,
